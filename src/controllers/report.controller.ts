...
class ReportController {
    ...
    public async updateReport(req: Request, res: Response, next: NextFunction): Promise<Response<IReport>> {
        try {
    ...
    public async getAllReports(req: Request, res: Response, next: NextFunction): Promise<Response<IReport[]>> {
        try {
    ...
    public getReportById(req: Request, res: Response, next: NextFunction): Response<IReport> {
        try {
