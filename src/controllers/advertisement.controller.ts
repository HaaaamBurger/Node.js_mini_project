...
class AdvertisementController {
  public async getAllAdvertisements(
    ...
    res: Response,
    next: NextFunction,
  ): Promise<Response<IAdvertisement[]>> {
    try {
  ...
  public getAdvertisementById(
    req: Request,
    res: Response,
    next: NextFunction,
  ): Response<IAdvertisement> {
    try {
  ...
  public async deleteAdvertisementById(
    req: Request,
    res: Response,
    next: NextFunction,
  ): Promise<void> {
  ...
  public async updateAdvertisementById(
    ...
    try {
      ...
      const createdAdvertisement =
        await advertisementService.updateAdvertisementById(body, adId);
  ...
  public async getUserAdvertisements(
    ...
    try {
      ...
      const advertisements =
        await advertisementService.getUserAdvertisements(id);
  ...
  public async uploadCarPhoto(
    ...
    try {
      ...
      const advertisement = await advertisementService.uploadCarPhoto(
        adId,
        car_photo,
      );
